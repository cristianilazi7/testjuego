(function (global, factory) {
    ...
    var NgxIntlTelInputComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.selectedCountryISO) {
                    this.selectedCountry = this.allCountries.find(function (c) { return (c.iso2.toLowerCase() === _this.selectedCountryISO.toLowerCase()); });
        ...
        NgxIntlTelInputComponent.propDecorators = {
            ...
            searchCountryFlag: [{ type: i0.Input }],
            searchCountryField: [{ type: i0.Input }],
            maxLength: [{ type: i0.Input }],
            tooltipField: [{ type: i0.Input }],
            selectFirstCountry: [{ type: i0.Input }],
            selectedCountryISO: [{ type: i0.Input }],
            phoneValidation: [{ type: i0.Input }],
            countryList: [{ type: i0.ViewChild, args: ['countryList',] }]
        };
